...
public class MainActivityTest {
    ...
    @Test
    public void openHelpActivity() throws Exception {
        onView(withId(R.id.trHelp)).perform(click());
        Helper.assertTwoClasses(HelpActivity.class.getName());
    }

    @Test
    public void openSettingsActivityFromButtons() throws Exception {
    ...
    @Test
    public void openExportActivityFromButtons() throws Exception {
