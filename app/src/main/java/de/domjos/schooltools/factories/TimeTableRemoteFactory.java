...
public class TimeTableRemoteFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if(color==context.getColor(R.color.Gray)) {
                row.setTextColor(R.id.lblHeader, DEFAULT_COLOR);
            } else {
    ...
    private void reloadTimeTable() {
        try {
            ...
            this.timeTableRow.add(new AbstractMap.SimpleEntry<>(this.context.getString(R.string.timetable_hour), DEFAULT_COLOR));
            this.timeTableRow.add(new AbstractMap.SimpleEntry<>(this.context.getString(R.string.timetable_days_mon), DEFAULT_COLOR));
            this.timeTableRow.add(new AbstractMap.SimpleEntry<>(this.context.getString(R.string.timetable_days_tue), DEFAULT_COLOR));
            this.timeTableRow.add(new AbstractMap.SimpleEntry<>(this.context.getString(R.string.timetable_days_wed), DEFAULT_COLOR));
            this.timeTableRow.add(new AbstractMap.SimpleEntry<>(this.context.getString(R.string.timetable_days_thu), DEFAULT_COLOR));
            this.timeTableRow.add(new AbstractMap.SimpleEntry<>(this.context.getString(R.string.timetable_days_fri), DEFAULT_COLOR));
            this.timeTableRow.add(new AbstractMap.SimpleEntry<>(this.context.getString(R.string.timetable_days_sat), DEFAULT_COLOR));
            this.timeTableRow.add(new AbstractMap.SimpleEntry<>(this.context.getString(R.string.timetable_days_sun), DEFAULT_COLOR));
            ...
            if(timeTables!=null) {
                if(!timeTables.isEmpty()) {
                    ...
                    for(int k = 0; k<=j; k++) {
                        ...
                        this.timeTableRow.add(new AbstractMap.SimpleEntry<>(String.valueOf(k+1), DEFAULT_COLOR));
