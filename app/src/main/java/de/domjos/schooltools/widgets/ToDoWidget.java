...
public class ToDoWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        remoteViews.setTextViewText(R.id.lblHeader, context.getString(R.string.main_importantToDos));
        remoteViews.setRemoteAdapter(R.id.lvToDos, serviceIntent);
