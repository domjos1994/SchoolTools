...
public class HourAdapter extends ArrayAdapter<Hour> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        TextView lblHoursStart = (TextView) rowView.findViewById(R.id.lblHoursStart);
        TextView lblHoursEnd = (TextView) rowView.findViewById(R.id.lblHoursEnd);
        TextView lblHoursBreak = (TextView) rowView.findViewById(R.id.lblHoursBreak);
