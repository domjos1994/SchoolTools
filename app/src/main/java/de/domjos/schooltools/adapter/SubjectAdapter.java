...
public class SubjectAdapter extends ArrayAdapter<Subject> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        TextView lblSubjectTitle = (TextView) rowView.findViewById(R.id.lblSubjectTitle);
        TextView lblSubjectAlias = (TextView) rowView.findViewById(R.id.lblSubjectAlias);
        LinearLayout ll = (LinearLayout) rowView.findViewById(R.id.item);
