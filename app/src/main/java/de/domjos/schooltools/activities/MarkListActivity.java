...
public class MarkListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.cmdMarkListOpenSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(MainActivity.settings.isExpertMode()) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(resultCode == RESULT_OK) {
            if(requestCode==99) {
                this.spMarkListType.setSelection(1);
            ...
            public void onClick(View v) {
                if(searchValidator.getState()) {
                    ...
                    try {
                        ...
                        Helper.createToast(getApplicationContext(), getString(R.string.message_validation_search_marklist));
                    }
                }
            }
        });
    ...
    private void calculateMarkList() {
        try {
            if(this.baseValidator.getState()) {
                MarkList markList;
                if(this.spMarkListType.getSelectedItemPosition()==0) {
                    markList = new GermanLinearList(this.getApplicationContext(), 20);
                } else if(this.spMarkListType.getSelectedItemPosition()==1) {
