...
public class SettingsActivityTest  {
    ...
    public void init() {
        ...
        set.addAll(Arrays.asList(context.getResources().getStringArray(R.array.settings_start_shown_modules_entries)));
        editor.putStringSet("lsShownModules", set);
        editor.commit();
    }

    @Test
    public void testShownModulesSettings() {
        Set<String> widgets;
        onView(withText(R.string.settings_start)).perform(click());
    ...
    @Test
    public void testStartWidgetSettings() {
        Set<String> widgets;
        onView(withText(R.string.settings_start)).perform(click());
